...
//  PieceMasters
//
//  Created by Anwar Al nasi on 21/11/1443 AH.
//
...
//            .padding (.top)
            ...
            VStack {
                ...
                VStack {
                    ...
                    HStack{
                 Image ("map")
                        Text("2821 al azhari, 6290, An Nuzhah, Riyadh 12471,Saudi Arabia").fontWeight(.light)
                            .font(.system(size: 10))
                            .padding (.trailing, 10)
                        }
                    }
...
final class ContentViewModel: NSObject, ObservableObject, CLLocationManagerDelegate{
    @Published var region = MKCoordinateRegion (center: CLLocationCoordinate2D(latitude: 24.8613, longitude: 46.7255), span: MKCoordinateSpan(latitudeDelta: 0.5, longitudeDelta: 0.5))
